...
export function SimpleSwap() {
  ...
  return (
    ...
    *Advanced Option document
      ...
      <a href="https://github.com/LongSna/SimpleSwap" target="_blank" rel="noopener noreferrer">Github</a>｜<a href="https://github.com/LongSna/SimpleSwap/blob/main/donate.md" target="_blank" rel="noopener noreferrer">Donate</a>
        </div>  
